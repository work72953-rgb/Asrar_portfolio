...
const cert = ["الحصول على شهادة تقدير للمساهمة في تحقيق اعتماد CBAHI"];
  ...
  return (
    ...
    `}
      >
        ...
        {cert.map((c, idx) => (
        <div className="w-full bg-gray-100/90 p-2 flex flex-col gap-3" key={idx}>
      ...
      </div>
       {
        ...
        block mx-auto mt-[15px]
          ...
          `} onClick={ShowContent}>
{show?'إخفاء بعض الشهادات':'إظهار المزيد من الشهادات'}
          </button> : ''
       }
    </div>
  );
